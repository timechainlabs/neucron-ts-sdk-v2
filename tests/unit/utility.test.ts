...
describe('Utility Service', () => {
    ...
    describe('Create Utility', () => {
        const mockData: CreateUtility = {
            ...
            tokenDetail: {
                // This is the correct field name, not 'properties'
                name: 'Utility Token',
                protocolId: 'STAS-20',
                symbol: 'UTIL',
        ...
        it('should successfully create a utility', async () => {
            ...
            expect(mockHttpClient.post).toHaveBeenCalledWith('/utility/register', mockData, {
    ...
    describe('Update Utility', () => {
        ...
        it('should successfully update a utility', async () => {
            ...
            expect(mockHttpClient.put).toHaveBeenCalledWith('/utility/update', mockData, {
                Authorization: 'test-auth-token-123',
            });
